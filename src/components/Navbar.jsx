    ...
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      <img src={assets.logo} alt="logo" className='w-36 h-auto' />
       ...
       ">
        ...
        <Link to="/theatres" className="hover:text-blue-400 transition">Theatres</Link>
        <Link to="/releases" className="hover:text-blue-400 transition">Releases</Link>
         <Link to="/favorite" className="hover:text-blue-400 transition">Favorites</Link>
