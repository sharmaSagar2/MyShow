...
import MovieCard from '../components/MovieCard'; // Make sure this component exists
...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto animate-pulse'>
        <img
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap mt-4 gap-4'>
            <button className='flex items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-700 transition rounded-md font-medium cursor-pointer active:scale-95'>
